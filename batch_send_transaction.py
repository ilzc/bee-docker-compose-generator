...
parser.add_argument('--bzz', '-bzz', help='转出bzz数量', default= 1, type=float)
parser.add_argument('--eth', '-eth', help='转出eth数量', default=0.1, type=float)
...
print("current gasPrice:%d eth_value:%f bzz_value:%f" % (gasPrice, eth_initail_value, gbzz_value))
